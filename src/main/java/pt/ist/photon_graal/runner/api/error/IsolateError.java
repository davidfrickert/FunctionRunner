package pt.ist.photon_graal.runner.api.error;
...
public class IsolateError implements Serializable {
    ...
    public static IsolateError fromThrowableFull(Throwable t) {
        return new IsolateError(t.getClass().getName(), t.getMessage(), ExceptionUtils.getStackTrace(t), fromThrowable(t.getCause()));
    }
